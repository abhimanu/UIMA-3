...
package edu.cmu.deiis.annotators.utils;
/* 
 *******************************************************************************************
...
public class CasConsumer extends CasConsumer_ImplBase {
  ...
  public void processCas(CAS aCAS) throws ResourceProcessException {
    ...
    FSIndex precisionIndex  = jcas.getAnnotationIndex(Precision.type);
    Iterator precIter = precisionIndex.iterator();
    while(precIter.hasNext()){
      System.out.println("Precision from CasConsumer" + precIter.next());
    }
